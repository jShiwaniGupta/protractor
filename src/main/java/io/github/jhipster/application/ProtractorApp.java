...
public class ProtractorApp {

    private static final Logger log = LoggerFactory.getLogger(ProtractorApp.class);

    private final Environment env;

    public ProtractorApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes protractor.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ProtractorApp.class);
